...
PACK.update({'word.add': 'Ajouter un mot',
 ...
 'word.replacehelp': 'Ces formes seront remplacées par « %1 ». Ajoutez uniquement ce qui doit toujours '
                     'être corrigé.',
 'word.more': 'Plus d’options',
 'word.hint': 'Aider à reconnaître ce mot',
 'word.hinthelp': 'Ce mot est transmis au service de reconnaissance, éventuellement avec l’audio dans '
                  'le cloud.',
