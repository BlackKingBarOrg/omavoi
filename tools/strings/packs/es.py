...
PACK.update({'word.add': 'Añadir palabra',
 ...
 'word.replacehelp': 'Estas variantes se cambiarán por «%1». Añade solo texto que quieras corregir '
                     'siempre.',
 'word.more': 'Más opciones',
 'word.hint': 'Ayudar a reconocer esta palabra',
 'word.hinthelp': 'Se proporciona esta palabra al servicio de voz. Los servicios en la nube pueden '
                  'recibirla junto al audio.',
